...
/**
 * A class that allows building an instance of [DodoPaymentsClientAsync] with [OkHttpClient] as the
...
class DodoPaymentsOkHttpClientAsync private constructor() {
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DodoPaymentsClientAsync]. */
        fun builder() = Builder()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DodoPaymentsClientAsync].
         *
