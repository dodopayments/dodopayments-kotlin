...
package com.dodo_payments.api.client.okhttp

import com.dodo_payments.api.client.DodoPaymentsClientAsync
import com.dodo_payments.api.client.DodoPaymentsClientAsyncImpl
import com.dodo_payments.api.core.ClientOptions
import com.dodo_payments.api.core.Timeout
...
class DodoPaymentsOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of
         * [DodoPaymentsOkHttpClientAsync].
         */
        fun builder() = Builder()

        fun fromEnv(): DodoPaymentsClientAsync = builder().fromEnv().build()
    }

    /** A builder for [DodoPaymentsOkHttpClientAsync]. */
    class Builder internal constructor() {

        private var clientOptions: ClientOptions.Builder = ClientOptions.builder()
        private var baseUrl: String = ClientOptions.LIVE_MODE_URL
        ...
        fun build(): DodoPaymentsClientAsync =
            DodoPaymentsClientAsyncImpl(
                clientOptions
                    .httpClient(
