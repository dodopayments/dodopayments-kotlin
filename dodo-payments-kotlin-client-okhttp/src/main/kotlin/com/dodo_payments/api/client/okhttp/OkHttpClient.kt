...
import com.dodo_payments.api.core.http.HttpClient
import com.dodo_payments.api.core.http.HttpMethod
import com.dodo_payments.api.core.http.HttpRequest
import com.dodo_payments.api.core.http.HttpRequestBody
import com.dodo_payments.api.core.http.HttpResponse
import com.dodo_payments.api.errors.DodoPaymentsIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw DodoPaymentsIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("DODO_PAYMENTS_LOG")?.lowercase()) {
