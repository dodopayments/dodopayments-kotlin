...
[![Maven Central](https://img.shields.io/maven-central/v/com.dodopayments.api/dodo-payments-kotlin)](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-kotlin/1.105.1)
[![javadoc](https://javadoc.io/badge2/com.dodopayments.api/dodo-payments-kotlin/1.105.1/javadoc.svg)](https://javadoc.io/doc/com.dodopayments.api/dodo-payments-kotlin/1.105.1)
...
The REST API documentation can be found on [docs.dodopayments.com](https://docs.dodopayments.com/api-reference/introduction). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.dodopayments.api/dodo-payments-kotlin/1.105.1).
...
```kotlin
implementation("com.dodopayments.api:dodo-payments-kotlin:1.105.1")
```
