...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.dodopayments.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.dodopayments.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.dodopayments.api.** {
    <init>(...);
