...
interface CreditEntitlementServiceAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CreditEntitlementServiceAsync
    ...
    /** @see retrieve */
    suspend fun retrieve(id: String, requestOptions: RequestOptions): CreditEntitlement =
    ...
    /** @see list */
    suspend fun list(requestOptions: RequestOptions): CreditEntitlementListPageAsync =
    ...
    /** @see undelete */
    suspend fun undelete(id: String, requestOptions: RequestOptions) =
    ...
    interface WithRawResponse {
        ...
        /** @see undelete */
        @MustBeClosed
        suspend fun undelete(id: String, requestOptions: RequestOptions): HttpResponse =
            undelete(id, CreditEntitlementUndeleteParams.none(), requestOptions)
    }
}
