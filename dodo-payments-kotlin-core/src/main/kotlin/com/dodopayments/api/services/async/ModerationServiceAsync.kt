...
interface ModerationServiceAsync {
    ...
    /** @see retrieveUsage */
    suspend fun retrieveUsage(requestOptions: RequestOptions): ModerationRetrieveUsageResponse =
    ...
    /** @see screen */
    suspend fun screen(requestOptions: RequestOptions): ModerationScreenResponse =
    ...
    interface WithRawResponse {
         ...
         * [ModerationServiceAsync.retrieveUsage].
         */
        @MustBeClosed
        suspend fun retrieveUsage(
            params: ModerationRetrieveUsageParams = ModerationRetrieveUsageParams.none(),
