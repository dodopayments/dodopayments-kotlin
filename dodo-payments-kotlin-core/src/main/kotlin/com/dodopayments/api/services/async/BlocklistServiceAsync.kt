...
interface BlocklistServiceAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): BlocklistServiceAsync

    fun customers(): CustomerServiceAsync

    /**
     * A view of [BlocklistServiceAsync] that provides access to raw HTTP responses for each method.
     */
