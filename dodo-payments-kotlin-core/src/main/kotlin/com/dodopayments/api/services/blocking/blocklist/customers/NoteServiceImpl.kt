...
class NoteServiceImpl internal constructor(private val clientOptions: ClientOptions) : NoteService {

    private val withRawResponse: NoteService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): NoteService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): NoteService =
        NoteServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            NoteServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
