...
interface UsageEventServiceAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): UsageEventServiceAsync
    ...
    /** @see list */
    suspend fun list(requestOptions: RequestOptions): UsageEventListPageAsync =
    ...
    interface WithRawResponse {
        ...
        /** @see list */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<UsageEventListPageAsync> =
            list(UsageEventListParams.none(), requestOptions)
