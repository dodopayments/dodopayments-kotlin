...
interface HeaderServiceAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): HeaderServiceAsync
    ...
    ): HeaderRetrieveResponse = retrieve(webhookId, HeaderRetrieveParams.none(), requestOptions)
