...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HeaderUpdateParams].
         *
    ...
    /** A builder for [HeaderUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(headerUpdateParams: HeaderUpdateParams) = apply {
            webhookId = headerUpdateParams.webhookId
            body = headerUpdateParams.body.toBuilder()
            additionalHeaders = headerUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = headerUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [HeaderUpdateParams].
         *
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("headers", headers), additionalProperties.toMutableMap())
        }
         ...
         */
        internal fun validity(): Int = (headers.asKnown()?.validity() ?: 0)
        ...
        override fun toString() =
            "Body{headers=$headers, additionalProperties=$additionalProperties}"
    }
