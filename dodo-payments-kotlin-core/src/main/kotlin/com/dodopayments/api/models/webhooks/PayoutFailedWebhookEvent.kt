...
class PayoutFailedWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PayoutFailedWebhookEvent].
         *
    ...
    /** A builder for [PayoutFailedWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("payout.failed")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(payoutFailedWebhookEvent: PayoutFailedWebhookEvent) = apply {
            businessId = payoutFailedWebhookEvent.businessId
            data = payoutFailedWebhookEvent.data
            timestamp = payoutFailedWebhookEvent.timestamp
            type = payoutFailedWebhookEvent.type
            additionalProperties = payoutFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PayoutFailedWebhookEvent].
         *
         ...
         */
        fun build(): PayoutFailedWebhookEvent =
     ...
     *   expected type.
     */
    fun validate(): PayoutFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("payout.failed")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("payout.failed")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PayoutFailedWebhookEvent &&
            businessId == other.businessId &&
            data == other.data &&
    ...
    override fun toString() =
        "PayoutFailedWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
