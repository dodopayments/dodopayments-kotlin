...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("refund.failed")
    ...
    fun validate(): RefundFailedWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("refund.failed")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("refund.failed")) 1 else 0 }
