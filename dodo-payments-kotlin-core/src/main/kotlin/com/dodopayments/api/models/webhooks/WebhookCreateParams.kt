...
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && url == other.url && description == other.description && disabled == other.disabled && filterTypes == other.filterTypes && headers == other.headers && idempotencyKey == other.idempotencyKey && metadata == other.metadata && rateLimit == other.rateLimit && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WebhookCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
