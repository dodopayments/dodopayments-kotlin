...
/**
 * Returns every transactional email sent to this customer in the last 180 days, newest first, with
 * its delivery outcome. Delivery status comes from the email provider and is as fresh as
...
private constructor(
    ...
    companion object {
        ...
        fun none(): EmailListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailListParams: EmailListParams) = apply {
            customerId = emailListParams.customerId
            pageNumber = emailListParams.pageNumber
            pageSize = emailListParams.pageSize
    ...
    override fun hashCode(): Int =
        Objects.hash(customerId, pageNumber, pageSize, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "EmailListParams{customerId=$customerId, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
