...
class SubscriptionUpdatedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.updated")
     * ```
     *
    ...
    /** A builder for [SubscriptionUpdatedWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("subscription.updated")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(subscriptionUpdatedWebhookEvent: SubscriptionUpdatedWebhookEvent) =
            apply {
                businessId = subscriptionUpdatedWebhookEvent.businessId
                data = subscriptionUpdatedWebhookEvent.data
                timestamp = subscriptionUpdatedWebhookEvent.timestamp
                type = subscriptionUpdatedWebhookEvent.type
                additionalProperties =
                    subscriptionUpdatedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SubscriptionUpdatedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionUpdatedWebhookEvent =
            SubscriptionUpdatedWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): SubscriptionUpdatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.updated")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.updated")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionUpdatedWebhookEvent &&
    ...
    override fun toString() =
        "SubscriptionUpdatedWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
