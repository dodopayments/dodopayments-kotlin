...
private constructor(
    ...
    companion object {
        ...
        fun none(): ProductRetrieveParams = builder().build()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProductRetrieveParams && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ProductRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
