...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentRetryParams: PaymentRetryParams) = apply {
            paymentId = paymentRetryParams.paymentId
    ...
    override fun hashCode(): Int =
        Objects.hash(paymentId, additionalHeaders, additionalQueryParams, additionalBodyProperties)

    override fun toString() =
        "PaymentRetryParams{paymentId=$paymentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
