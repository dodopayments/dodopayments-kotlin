...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.expired")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("subscription.expired")
    ...
    fun validate(): SubscriptionExpiredWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.expired")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.expired")) 1 else 0 }
