...
class DunningStartedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("dunning.started")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DunningStartedWebhookEvent].
         *
    ...
    /** A builder for [DunningStartedWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("dunning.started")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(dunningStartedWebhookEvent: DunningStartedWebhookEvent) = apply {
            businessId = dunningStartedWebhookEvent.businessId
            data = dunningStartedWebhookEvent.data
            timestamp = dunningStartedWebhookEvent.timestamp
            type = dunningStartedWebhookEvent.type
            additionalProperties = dunningStartedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DunningStartedWebhookEvent].
         *
         ...
         */
        fun build(): DunningStartedWebhookEvent =
    ...
    fun validate(): DunningStartedWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("dunning.started")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("dunning.started")) 1 else 0 }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.triggerState] with a well-typed [TriggerState] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        class TriggerState @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DunningStartedWebhookEvent &&
    ...
    override fun toString() =
        "DunningStartedWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
