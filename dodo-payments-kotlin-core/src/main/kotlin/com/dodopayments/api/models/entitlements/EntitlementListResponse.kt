...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = entitlementListResponse.metadata().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntitlementListResponse].
         *
    ...
    /** A builder for [EntitlementListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(entitlementListResponse: EntitlementListResponse) = apply {
            id = entitlementListResponse.id
            businessId = entitlementListResponse.businessId
            createdAt = entitlementListResponse.createdAt
            integrationConfig = entitlementListResponse.integrationConfig
            integrationType = entitlementListResponse.integrationType
            isActive = entitlementListResponse.isActive
            name = entitlementListResponse.name
            updatedAt = entitlementListResponse.updatedAt
            description = entitlementListResponse.description
            metadata = entitlementListResponse.metadata
            additionalProperties = entitlementListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntitlementListResponse].
         *
         ...
         */
        fun build(): EntitlementListResponse =
    ...
    fun validate(): EntitlementListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "EntitlementListResponse{id=$id, businessId=$businessId, createdAt=$createdAt, integrationConfig=$integrationConfig, integrationType=$integrationType, isActive=$isActive, name=$name, updatedAt=$updatedAt, description=$description, metadata=$metadata, additionalProperties=$additionalProperties}"
}
