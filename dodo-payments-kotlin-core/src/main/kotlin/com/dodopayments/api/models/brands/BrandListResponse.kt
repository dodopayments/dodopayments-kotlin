...
private constructor(
    ...
    private constructor(
         ...
         *
         * Unlike [verificationEnabled], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("verification_enabled")
        @ExcludeMissing
         ...
         *
         * Unlike [reasonForHold], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("reason_for_hold")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(item: Item) = apply {
                ...
                statementDescriptor = item.statementDescriptor
                verificationEnabled = item.verificationEnabled
                verificationStatus = item.verificationStatus
                description = item.description
                image = item.image
                name = item.name
                reasonForHold = item.reasonForHold
             ...
             *
             * You should usually call [Builder.verificationEnabled] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.reasonForHold] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            fun known(): Known =
                when (this) {
                    ...
                    HOLD -> Known.HOLD
                        ...
                        throw DodoPaymentsInvalidDataException("Unknown VerificationStatus: $value")
                }
        ...
        override fun toString() =
            "Item{brandId=$brandId, businessId=$businessId, enabled=$enabled, statementDescriptor=$statementDescriptor, verificationEnabled=$verificationEnabled, verificationStatus=$verificationStatus, description=$description, image=$image, name=$name, reasonForHold=$reasonForHold, supportEmail=$supportEmail, url=$url, additionalProperties=$additionalProperties}"
    }
