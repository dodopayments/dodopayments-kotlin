...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(licenseKeyInstanceRetrieveParams: LicenseKeyInstanceRetrieveParams) =
            apply {
                id = licenseKeyInstanceRetrieveParams.id
                additionalHeaders = licenseKeyInstanceRetrieveParams.additionalHeaders.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LicenseKeyInstanceRetrieveParams && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "LicenseKeyInstanceRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
