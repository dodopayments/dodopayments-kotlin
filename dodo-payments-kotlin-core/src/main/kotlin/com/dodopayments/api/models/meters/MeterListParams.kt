...
private constructor(
    ...
    companion object {
        ...
        fun none(): MeterListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(meterListParams: MeterListParams) = apply {
            archived = meterListParams.archived
            pageNumber = meterListParams.pageNumber
    ...
    override fun hashCode(): Int =
        Objects.hash(archived, pageNumber, pageSize, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "MeterListParams{archived=$archived, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
