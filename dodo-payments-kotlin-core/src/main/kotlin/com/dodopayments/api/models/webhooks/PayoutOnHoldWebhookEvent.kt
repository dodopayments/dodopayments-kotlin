...
class PayoutOnHoldWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PayoutOnHoldWebhookEvent].
         *
    ...
    /** A builder for [PayoutOnHoldWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("payout.on_hold")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(payoutOnHoldWebhookEvent: PayoutOnHoldWebhookEvent) = apply {
            businessId = payoutOnHoldWebhookEvent.businessId
            data = payoutOnHoldWebhookEvent.data
            timestamp = payoutOnHoldWebhookEvent.timestamp
            type = payoutOnHoldWebhookEvent.type
            additionalProperties = payoutOnHoldWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PayoutOnHoldWebhookEvent].
         *
         ...
         */
        fun build(): PayoutOnHoldWebhookEvent =
     ...
     *   expected type.
     */
    fun validate(): PayoutOnHoldWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("payout.on_hold")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("payout.on_hold")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PayoutOnHoldWebhookEvent &&
            businessId == other.businessId &&
            data == other.data &&
    ...
    override fun toString() =
        "PayoutOnHoldWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
