...
class PayoutInProgressWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("payout.in_progress")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PayoutInProgressWebhookEvent].
         *
    ...
    /** A builder for [PayoutInProgressWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("payout.in_progress")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(payoutInProgressWebhookEvent: PayoutInProgressWebhookEvent) = apply {
            businessId = payoutInProgressWebhookEvent.businessId
            data = payoutInProgressWebhookEvent.data
            timestamp = payoutInProgressWebhookEvent.timestamp
            type = payoutInProgressWebhookEvent.type
            additionalProperties = payoutInProgressWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PayoutInProgressWebhookEvent].
         *
         ...
         */
        fun build(): PayoutInProgressWebhookEvent =
     ...
     *   expected type.
     */
    fun validate(): PayoutInProgressWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("payout.in_progress")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("payout.in_progress")) 1 else 0 }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                name = data.name
                payoutDocumentUrl = data.payoutDocumentUrl
             ...
             *
             * You should usually call [Builder.fee] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.payoutId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.tax] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
            @Deprecated(
        ...
        override fun toString() =
            "Data{amount=$amount, businessId=$businessId, chargebacks=$chargebacks, createdAt=$createdAt, currency=$currency, fee=$fee, paymentMethod=$paymentMethod, payoutId=$payoutId, refunds=$refunds, status=$status, tax=$tax, updatedAt=$updatedAt, name=$name, payoutDocumentUrl=$payoutDocumentUrl, remarks=$remarks, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PayoutInProgressWebhookEvent &&
            businessId == other.businessId &&
            data == other.data &&
    ...
    override fun toString() =
        "PayoutInProgressWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
