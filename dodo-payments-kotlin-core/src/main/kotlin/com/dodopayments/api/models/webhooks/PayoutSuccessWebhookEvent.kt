...
class PayoutSuccessWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PayoutSuccessWebhookEvent].
         *
    ...
    /** A builder for [PayoutSuccessWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("payout.success")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(payoutSuccessWebhookEvent: PayoutSuccessWebhookEvent) = apply {
            businessId = payoutSuccessWebhookEvent.businessId
            data = payoutSuccessWebhookEvent.data
            timestamp = payoutSuccessWebhookEvent.timestamp
            type = payoutSuccessWebhookEvent.type
            additionalProperties = payoutSuccessWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PayoutSuccessWebhookEvent].
         *
         ...
         */
        fun build(): PayoutSuccessWebhookEvent =
     ...
     *   expected type.
     */
    fun validate(): PayoutSuccessWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("payout.success")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("payout.success")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PayoutSuccessWebhookEvent &&
            businessId == other.businessId &&
            data == other.data &&
    ...
    override fun toString() =
        "PayoutSuccessWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
