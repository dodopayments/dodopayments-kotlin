...
private constructor(
    ...
    private val scheduledChange: JsonField<ScheduledChange>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        scheduledChange: JsonField<ScheduledChange> = JsonMissing.of(),
     ...
     *   the server responded with an unexpected value).
     */
    fun scheduledChange(): ScheduledChange? = scheduledChange.getNullable("scheduled_change")
    ...
    @JsonProperty("scheduled_change")
    @ExcludeMissing
    fun _scheduledChange(): JsonField<ScheduledChange> = scheduledChange
    ...
    class Builder internal constructor() {
        ...
        private var scheduledChange: JsonField<ScheduledChange> = JsonMissing.of()
        ...
        /** Scheduled plan change details, if any */
        fun scheduledChange(scheduledChange: ScheduledChange?) =
            scheduledChange(JsonField.ofNullable(scheduledChange))

        /**
         * Sets [Builder.scheduledChange] to an arbitrary JSON value.
         *
         * You should usually call [Builder.scheduledChange] with a well-typed [ScheduledChange]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun scheduledChange(scheduledChange: JsonField<ScheduledChange>) = apply {
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val TOO_EXPENSIVE = of("too_expensive")

            val MISSING_FEATURES = of("missing_features")

            val SWITCHED_SERVICE = of("switched_service")

            val UNUSED = of("unused")

            val CUSTOMER_SERVICE = of("customer_service")

            val LOW_QUALITY = of("low_quality")

            val TOO_COMPLEX = of("too_complex")

            val OTHER = of("other")

            fun of(value: String) = CancellationFeedback(JsonField.of(value))
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [ScheduledChange].
             *
             * The following fields are required:
             * ```kotlin
             * .id()
        ...
        class Builder internal constructor() {
            ...
            internal fun from(scheduledChange: ScheduledChange) = apply {
                id = scheduledChange.id
                addons = scheduledChange.addons.map { it.toMutableList() }
                createdAt = scheduledChange.createdAt
                effectiveAt = scheduledChange.effectiveAt
                productId = scheduledChange.productId
                quantity = scheduledChange.quantity
                productDescription = scheduledChange.productDescription
                productName = scheduledChange.productName
                additionalProperties = scheduledChange.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [ScheduledChange].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
        ...
        fun validate(): ScheduledChange = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ScheduledChange &&
                id == other.id &&
                addons == other.addons &&
        ...
        override fun toString() =
            "ScheduledChange{id=$id, addons=$addons, createdAt=$createdAt, effectiveAt=$effectiveAt, productId=$productId, quantity=$quantity, productDescription=$productDescription, productName=$productName, additionalProperties=$additionalProperties}"
    }
