...
class SubscriptionPastDueWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.past_due")
     * ```
     *
    ...
    /** A builder for [SubscriptionPastDueWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("subscription.past_due")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(subscriptionPastDueWebhookEvent: SubscriptionPastDueWebhookEvent) =
            apply {
                businessId = subscriptionPastDueWebhookEvent.businessId
                data = subscriptionPastDueWebhookEvent.data
                timestamp = subscriptionPastDueWebhookEvent.timestamp
                type = subscriptionPastDueWebhookEvent.type
                additionalProperties =
                    subscriptionPastDueWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SubscriptionPastDueWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionPastDueWebhookEvent =
            SubscriptionPastDueWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): SubscriptionPastDueWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.past_due")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.past_due")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionPastDueWebhookEvent &&
    ...
    override fun toString() =
        "SubscriptionPastDueWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
