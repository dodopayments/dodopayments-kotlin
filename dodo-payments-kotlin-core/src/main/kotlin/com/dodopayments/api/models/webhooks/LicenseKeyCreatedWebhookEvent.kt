...
private constructor(
    ...
    private val data: JsonField<LicenseKey>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<LicenseKey> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): LicenseKey = data.getRequired("data")
     ...
     * ```kotlin
     * JsonValue.from("license_key.created")
     * ```
     *
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<LicenseKey> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<LicenseKey>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("license_key.created")
        ...
        fun data(data: LicenseKey) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [LicenseKey] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<LicenseKey>) = apply { this.data = data }
    ...
    fun validate(): LicenseKeyCreatedWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("license_key.created")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("license_key.created")) 1 else 0 }
