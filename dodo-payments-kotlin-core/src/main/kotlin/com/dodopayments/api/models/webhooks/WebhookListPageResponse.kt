...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WebhookListPageResponse && data == other.data && done == other.done && iterator == other.iterator && prevIterator == other.prevIterator && additionalProperties == other.additionalProperties /* spotless:on */
    }
