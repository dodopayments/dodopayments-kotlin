...
class EntitlementUpdateResponse
...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = entitlementUpdateResponse.metadata().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntitlementUpdateResponse].
         *
    ...
    /** A builder for [EntitlementUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(entitlementUpdateResponse: EntitlementUpdateResponse) = apply {
            id = entitlementUpdateResponse.id
            businessId = entitlementUpdateResponse.businessId
            createdAt = entitlementUpdateResponse.createdAt
            integrationConfig = entitlementUpdateResponse.integrationConfig
            integrationType = entitlementUpdateResponse.integrationType
            isActive = entitlementUpdateResponse.isActive
            name = entitlementUpdateResponse.name
            updatedAt = entitlementUpdateResponse.updatedAt
            description = entitlementUpdateResponse.description
            metadata = entitlementUpdateResponse.metadata
            additionalProperties = entitlementUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntitlementUpdateResponse].
         *
         ...
         */
        fun build(): EntitlementUpdateResponse =
    ...
    fun validate(): EntitlementUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "EntitlementUpdateResponse{id=$id, businessId=$businessId, createdAt=$createdAt, integrationConfig=$integrationConfig, integrationType=$integrationType, isActive=$isActive, name=$name, updatedAt=$updatedAt, description=$description, metadata=$metadata, additionalProperties=$additionalProperties}"
}
