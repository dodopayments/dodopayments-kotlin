...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(groupCreateResponse: GroupCreateResponse) = apply {
            ...
            products = groupCreateResponse.products.map { it.toMutableList() }
            status = groupCreateResponse.status
            groupName = groupCreateResponse.groupName
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.filesCount] with a well-typed [Long] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.hasCreditEntitlements] with a well-typed [Boolean]
    ...
    override fun toString() =
        "GroupCreateResponse{groupId=$groupId, products=$products, status=$status, groupName=$groupName, additionalProperties=$additionalProperties}"
}
