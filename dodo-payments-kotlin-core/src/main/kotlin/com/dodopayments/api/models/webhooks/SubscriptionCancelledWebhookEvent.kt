...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.cancelled")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("subscription.cancelled")
    ...
    fun validate(): SubscriptionCancelledWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.cancelled")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.cancelled")) 1 else 0 }
