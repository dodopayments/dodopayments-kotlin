...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("payment.processing")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("payment.processing")
    ...
    fun validate(): PaymentProcessingWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("payment.processing")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("payment.processing")) 1 else 0 }
