...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionListPageResponse: SubscriptionListPageResponse) = apply {
            items = subscriptionListPageResponse.items.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubscriptionListPageResponse && items == other.items && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "SubscriptionListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
