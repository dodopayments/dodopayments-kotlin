...
private constructor(
    ...
    /** A builder for [CheckoutSessionBillingAddress]. */
    class Builder internal constructor() {
        ...
        internal fun from(checkoutSessionBillingAddress: CheckoutSessionBillingAddress) = apply {
            country = checkoutSessionBillingAddress.country
            city = checkoutSessionBillingAddress.city
            state = checkoutSessionBillingAddress.state
            street = checkoutSessionBillingAddress.street
            zipcode = checkoutSessionBillingAddress.zipcode
            additionalProperties = checkoutSessionBillingAddress.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CheckoutSessionBillingAddress].
         *
         ...
         */
        fun build(): CheckoutSessionBillingAddress =
            CheckoutSessionBillingAddress(
    ...
    fun validate(): CheckoutSessionBillingAddress = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CheckoutSessionBillingAddress &&
    ...
    override fun toString() =
        "CheckoutSessionBillingAddress{country=$country, city=$city, state=$state, street=$street, zipcode=$zipcode, additionalProperties=$additionalProperties}"
}
