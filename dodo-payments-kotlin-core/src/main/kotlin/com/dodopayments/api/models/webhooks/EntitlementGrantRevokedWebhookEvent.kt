...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("entitlement_grant.revoked")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("entitlement_grant.revoked")
    ...
    fun validate(): EntitlementGrantRevokedWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("entitlement_grant.revoked")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("entitlement_grant.revoked")) 1 else 0 }
