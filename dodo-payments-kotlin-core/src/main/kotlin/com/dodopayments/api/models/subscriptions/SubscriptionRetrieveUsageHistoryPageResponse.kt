...
private constructor(
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<SubscriptionRetrieveUsageHistoryResponse>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<SubscriptionRetrieveUsageHistoryResponse>>? = null
