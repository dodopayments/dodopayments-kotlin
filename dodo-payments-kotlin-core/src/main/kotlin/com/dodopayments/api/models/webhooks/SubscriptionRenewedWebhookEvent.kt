...
class SubscriptionRenewedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.renewed")
     * ```
     *
    ...
    /** A builder for [SubscriptionRenewedWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("subscription.renewed")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(subscriptionRenewedWebhookEvent: SubscriptionRenewedWebhookEvent) =
            apply {
                businessId = subscriptionRenewedWebhookEvent.businessId
                data = subscriptionRenewedWebhookEvent.data
                timestamp = subscriptionRenewedWebhookEvent.timestamp
                type = subscriptionRenewedWebhookEvent.type
                additionalProperties =
                    subscriptionRenewedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SubscriptionRenewedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionRenewedWebhookEvent =
            SubscriptionRenewedWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): SubscriptionRenewedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.renewed")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.renewed")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionRenewedWebhookEvent &&
    ...
    override fun toString() =
        "SubscriptionRenewedWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
