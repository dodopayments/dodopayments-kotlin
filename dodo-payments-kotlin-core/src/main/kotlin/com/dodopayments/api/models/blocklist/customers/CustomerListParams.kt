...
private constructor(
    private val blockedByEmail: String?,
    ...
    fun blockedByEmail(): String? = blockedByEmail
    ...
    class Builder internal constructor() {
        ...
        private var blockedByEmail: String? = null
        ...
        internal fun from(customerListParams: CustomerListParams) = apply {
            blockedByEmail = customerListParams.blockedByEmail
            createdAtGte = customerListParams.createdAtGte
            createdAtLte = customerListParams.createdAtLte
            identifier = customerListParams.identifier
        ...
        /** Filter by the dashboard user who blocked the customer. */
        fun blockedByEmail(blockedByEmail: String?) = apply { this.blockedByEmail = blockedByEmail }
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                blockedByEmail?.let { put("blocked_by_email", it) }
                createdAtGte?.let {
    ...
    override fun toString() =
        "CustomerListParams{blockedByEmail=$blockedByEmail, createdAtGte=$createdAtGte, createdAtLte=$createdAtLte, identifier=$identifier, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
