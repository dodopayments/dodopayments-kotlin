...
private constructor(
     ...
     * import com.dodopayments.api.core.JsonValue
     *
     * val result: String? = customerRequest.accept(object : CustomerRequest.Visitor<String?> {
     *     override fun visitAttachExistingCustomer(attachExistingCustomer: AttachExistingCustomer): String? = attachExistingCustomer.toString()
     *
     *     // ...
     *
