...
class AbandonedCheckoutRecoveredWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("abandoned_checkout.recovered")
     * ```
     *
    ...
    /** A builder for [AbandonedCheckoutRecoveredWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("abandoned_checkout.recovered")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(
            abandonedCheckoutRecoveredWebhookEvent: AbandonedCheckoutRecoveredWebhookEvent
        ) = apply {
            businessId = abandonedCheckoutRecoveredWebhookEvent.businessId
            data = abandonedCheckoutRecoveredWebhookEvent.data
            timestamp = abandonedCheckoutRecoveredWebhookEvent.timestamp
            type = abandonedCheckoutRecoveredWebhookEvent.type
            additionalProperties =
                abandonedCheckoutRecoveredWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AbandonedCheckoutRecoveredWebhookEvent].
         *
         ...
         */
        fun build(): AbandonedCheckoutRecoveredWebhookEvent =
            AbandonedCheckoutRecoveredWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): AbandonedCheckoutRecoveredWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("abandoned_checkout.recovered")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("abandoned_checkout.recovered")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AbandonedCheckoutRecoveredWebhookEvent &&
    ...
    override fun toString() =
        "AbandonedCheckoutRecoveredWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
