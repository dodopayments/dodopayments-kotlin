...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("dispute.won")
    ...
    fun validate(): DisputeWonWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("dispute.won")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("dispute.won")) 1 else 0 }
