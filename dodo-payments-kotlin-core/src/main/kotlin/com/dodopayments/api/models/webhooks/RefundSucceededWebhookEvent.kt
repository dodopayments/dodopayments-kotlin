...
private constructor(
    ...
    private val data: JsonField<Refund>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<Refund> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): Refund = data.getRequired("data")
     ...
     * ```kotlin
     * JsonValue.from("refund.succeeded")
     * ```
     *
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Refund> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<Refund>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("refund.succeeded")
        ...
        fun data(data: Refund) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Refund] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Refund>) = apply { this.data = data }
    ...
    fun validate(): RefundSucceededWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("refund.succeeded")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("refund.succeeded")) 1 else 0 }
