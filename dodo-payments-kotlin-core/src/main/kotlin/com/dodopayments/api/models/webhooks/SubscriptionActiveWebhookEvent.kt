...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.active")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("subscription.active")
    ...
    fun validate(): SubscriptionActiveWebhookEvent = apply {
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.active")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.active")) 1 else 0 }
