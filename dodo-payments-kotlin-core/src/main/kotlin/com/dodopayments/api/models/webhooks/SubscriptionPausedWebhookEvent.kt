...
class SubscriptionPausedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.paused")
     * ```
     *
    ...
    /** A builder for [SubscriptionPausedWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("subscription.paused")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(subscriptionPausedWebhookEvent: SubscriptionPausedWebhookEvent) = apply {
            businessId = subscriptionPausedWebhookEvent.businessId
            data = subscriptionPausedWebhookEvent.data
            timestamp = subscriptionPausedWebhookEvent.timestamp
            type = subscriptionPausedWebhookEvent.type
            additionalProperties =
                subscriptionPausedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionPausedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionPausedWebhookEvent =
            SubscriptionPausedWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): SubscriptionPausedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.paused")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.paused")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionPausedWebhookEvent &&
    ...
    override fun toString() =
        "SubscriptionPausedWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
