...
private constructor(
    ...
    /**
     * The amount to be refunded. Must be non-negative. Optional. Partial refunds are currently
     * disabled.
     */
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && paymentId == other.paymentId && amount == other.amount && reason == other.reason && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(paymentId, amount, reason, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{paymentId=$paymentId, amount=$amount, reason=$reason, additionalProperties=$additionalProperties}"
    }
