...
class ProductCollectionCreateResponse
...
private constructor(
    ...
    /** A builder for [ProductCollectionCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(productCollectionCreateResponse: ProductCollectionCreateResponse) =
            apply {
                id = productCollectionCreateResponse.id
                brandId = productCollectionCreateResponse.brandId
                createdAt = productCollectionCreateResponse.createdAt
                groups = productCollectionCreateResponse.groups.map { it.toMutableList() }
                name = productCollectionCreateResponse.name
                updatedAt = productCollectionCreateResponse.updatedAt
                description = productCollectionCreateResponse.description
                image = productCollectionCreateResponse.image
                additionalProperties =
                    productCollectionCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ProductCollectionCreateResponse].
         *
         ...
         */
        fun build(): ProductCollectionCreateResponse =
            ProductCollectionCreateResponse(
                checkRequired("id", id),
    ...
    fun validate(): ProductCollectionCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductCollectionCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ProductCollectionCreateResponse{id=$id, brandId=$brandId, createdAt=$createdAt, groups=$groups, name=$name, updatedAt=$updatedAt, description=$description, image=$image, additionalProperties=$additionalProperties}"
}
