...
class SubscriptionOnHoldWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.on_hold")
     * ```
     *
    ...
    /** A builder for [SubscriptionOnHoldWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("subscription.on_hold")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(subscriptionOnHoldWebhookEvent: SubscriptionOnHoldWebhookEvent) = apply {
            businessId = subscriptionOnHoldWebhookEvent.businessId
            data = subscriptionOnHoldWebhookEvent.data
            timestamp = subscriptionOnHoldWebhookEvent.timestamp
            type = subscriptionOnHoldWebhookEvent.type
            additionalProperties =
                subscriptionOnHoldWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionOnHoldWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionOnHoldWebhookEvent =
            SubscriptionOnHoldWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): SubscriptionOnHoldWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.on_hold")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.on_hold")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionOnHoldWebhookEvent &&
    ...
    override fun toString() =
        "SubscriptionOnHoldWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
