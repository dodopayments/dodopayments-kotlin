...
private constructor(
    ...
    companion object {
        ...
        fun none(): BrandListParams = builder().build()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BrandListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
