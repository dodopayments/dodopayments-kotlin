...
private constructor(
    ...
    companion object {
        ...
        fun none(): MeterRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): MeterRetrieveParams =
            MeterRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "MeterRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
