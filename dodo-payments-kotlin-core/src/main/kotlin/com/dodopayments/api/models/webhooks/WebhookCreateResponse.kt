...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookCreateResponse: WebhookCreateResponse) = apply {
            ...
            metadata = webhookCreateResponse.metadata
            updatedAt = webhookCreateResponse.updatedAt
            url = webhookCreateResponse.url
            disabled = webhookCreateResponse.disabled
            filterTypes = webhookCreateResponse.filterTypes.map { it.toMutableList() }
            rateLimit = webhookCreateResponse.rateLimit
    ...
    override fun toString() =
        "WebhookCreateResponse{id=$id, createdAt=$createdAt, description=$description, metadata=$metadata, updatedAt=$updatedAt, url=$url, disabled=$disabled, filterTypes=$filterTypes, rateLimit=$rateLimit, additionalProperties=$additionalProperties}"
}
