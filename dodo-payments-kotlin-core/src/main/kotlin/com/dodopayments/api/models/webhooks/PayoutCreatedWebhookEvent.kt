...
class PayoutCreatedWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PayoutCreatedWebhookEvent].
         *
    ...
    /** A builder for [PayoutCreatedWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("payout.created")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(payoutCreatedWebhookEvent: PayoutCreatedWebhookEvent) = apply {
            businessId = payoutCreatedWebhookEvent.businessId
            data = payoutCreatedWebhookEvent.data
            timestamp = payoutCreatedWebhookEvent.timestamp
            type = payoutCreatedWebhookEvent.type
            additionalProperties = payoutCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PayoutCreatedWebhookEvent].
         *
         ...
         */
        fun build(): PayoutCreatedWebhookEvent =
     ...
     *   expected type.
     */
    fun validate(): PayoutCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("payout.created")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("payout.created")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PayoutCreatedWebhookEvent &&
            businessId == other.businessId &&
            data == other.data &&
    ...
    override fun toString() =
        "PayoutCreatedWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
