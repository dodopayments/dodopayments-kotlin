...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookUpdateResponse: WebhookUpdateResponse) = apply {
            ...
            metadata = webhookUpdateResponse.metadata
            updatedAt = webhookUpdateResponse.updatedAt
            url = webhookUpdateResponse.url
            disabled = webhookUpdateResponse.disabled
            filterTypes = webhookUpdateResponse.filterTypes.map { it.toMutableList() }
            rateLimit = webhookUpdateResponse.rateLimit
    ...
    override fun toString() =
        "WebhookUpdateResponse{id=$id, createdAt=$createdAt, description=$description, metadata=$metadata, updatedAt=$updatedAt, url=$url, disabled=$disabled, filterTypes=$filterTypes, rateLimit=$rateLimit, additionalProperties=$additionalProperties}"
}
