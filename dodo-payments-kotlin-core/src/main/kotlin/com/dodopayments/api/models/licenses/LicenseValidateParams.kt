...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseValidateParams].
         *
    ...
    /** A builder for [LicenseValidateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(licenseValidateParams: LicenseValidateParams) = apply {
            body = licenseValidateParams.body.toBuilder()
            additionalHeaders = licenseValidateParams.additionalHeaders.toBuilder()
            additionalQueryParams = licenseValidateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LicenseValidateParams].
         *
         ...
         */
        fun build(): LicenseValidateParams =
    ...
    private constructor(
        ...
        fun licenseKeyInstanceId(): String? =
            licenseKeyInstanceId.getNullable("license_key_instance_id")
        ...
        class Builder internal constructor() {
            ...
            private var licenseKeyInstanceId: JsonField<String> = JsonMissing.of()
            ...
            fun licenseKeyInstanceId(licenseKeyInstanceId: String?) =
                licenseKeyInstanceId(JsonField.ofNullable(licenseKeyInstanceId))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LicenseValidateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "LicenseValidateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
