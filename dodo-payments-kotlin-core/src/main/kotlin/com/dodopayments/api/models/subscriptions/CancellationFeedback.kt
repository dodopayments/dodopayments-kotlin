...
class CancellationFeedback @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    /**
     * An enum containing [CancellationFeedback]'s known values, as well as an [_UNKNOWN] member.
     *
    ...
    enum class Value {
        ...
        OTHER,
        /**
         * An enum member indicating that [CancellationFeedback] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            OTHER -> Known.OTHER
            else -> throw DodoPaymentsInvalidDataException("Unknown CancellationFeedback: $value")
        }
