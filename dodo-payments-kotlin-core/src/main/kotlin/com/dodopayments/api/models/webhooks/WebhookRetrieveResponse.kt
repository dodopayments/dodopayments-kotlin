...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookRetrieveResponse: WebhookRetrieveResponse) = apply {
            ...
            description = webhookRetrieveResponse.description
            metadata = webhookRetrieveResponse.metadata
            updatedAt = webhookRetrieveResponse.updatedAt
            url = webhookRetrieveResponse.url
            disabled = webhookRetrieveResponse.disabled
            filterTypes = webhookRetrieveResponse.filterTypes.map { it.toMutableList() }
            rateLimit = webhookRetrieveResponse.rateLimit
    ...
    override fun toString() =
        "WebhookRetrieveResponse{id=$id, createdAt=$createdAt, description=$description, metadata=$metadata, updatedAt=$updatedAt, url=$url, disabled=$disabled, filterTypes=$filterTypes, rateLimit=$rateLimit, additionalProperties=$additionalProperties}"
}
