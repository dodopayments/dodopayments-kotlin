...
class SubscriptionUpdatePaymentMethodWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * JsonValue.from("subscription.update_payment_method")
     * ```
     *
    ...
    /** A builder for [SubscriptionUpdatePaymentMethodWebhookEvent]. */
    class Builder internal constructor() {

        private var businessId: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonValue = JsonValue.from("subscription.update_payment_method")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(
            subscriptionUpdatePaymentMethodWebhookEvent: SubscriptionUpdatePaymentMethodWebhookEvent
        ) = apply {
            businessId = subscriptionUpdatePaymentMethodWebhookEvent.businessId
            data = subscriptionUpdatePaymentMethodWebhookEvent.data
            timestamp = subscriptionUpdatePaymentMethodWebhookEvent.timestamp
            type = subscriptionUpdatePaymentMethodWebhookEvent.type
            additionalProperties =
                subscriptionUpdatePaymentMethodWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionUpdatePaymentMethodWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionUpdatePaymentMethodWebhookEvent =
            SubscriptionUpdatePaymentMethodWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): SubscriptionUpdatePaymentMethodWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        timestamp()
        _type().let {
            if (it != JsonValue.from("subscription.update_payment_method")) {
    ...
    internal fun validity(): Int =
        (if (businessId.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("subscription.update_payment_method")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionUpdatePaymentMethodWebhookEvent &&
    ...
    override fun toString() =
        "SubscriptionUpdatePaymentMethodWebhookEvent{businessId=$businessId, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
