...
private constructor(
    ...
    companion object {
        ...
        fun none(): PayoutListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PayoutListParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PayoutListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PayoutListParams && pageNumber == other.pageNumber && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
