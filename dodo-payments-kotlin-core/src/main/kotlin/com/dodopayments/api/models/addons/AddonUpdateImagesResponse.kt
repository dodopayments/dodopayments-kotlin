...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AddonUpdateImagesResponse && imageId == other.imageId && url == other.url && additionalProperties == other.additionalProperties /* spotless:on */
    }
