...
private constructor(
    ...
    companion object {
        ...
        fun none(): GrantListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GrantListParams]. */
        fun builder() = Builder()
    }

    /** A builder for [GrantListParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [GrantListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GrantListParams =
            GrantListParams(
                id,
                customerId,
                pageNumber,
