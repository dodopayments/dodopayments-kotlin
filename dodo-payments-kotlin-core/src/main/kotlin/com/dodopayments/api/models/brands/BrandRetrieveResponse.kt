...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(brandRetrieveResponse: BrandRetrieveResponse) = apply {
            ...
            businessId = brandRetrieveResponse.businessId
            enabled = brandRetrieveResponse.enabled
            statementDescriptor = brandRetrieveResponse.statementDescriptor
            verificationEnabled = brandRetrieveResponse.verificationEnabled
            verificationStatus = brandRetrieveResponse.verificationStatus
            description = brandRetrieveResponse.description
            image = brandRetrieveResponse.image
            name = brandRetrieveResponse.name
            reasonForHold = brandRetrieveResponse.reasonForHold
            supportEmail = brandRetrieveResponse.supportEmail
            url = brandRetrieveResponse.url
    ...
    override fun toString() =
        "BrandRetrieveResponse{brandId=$brandId, businessId=$businessId, enabled=$enabled, statementDescriptor=$statementDescriptor, verificationEnabled=$verificationEnabled, verificationStatus=$verificationStatus, description=$description, image=$image, name=$name, reasonForHold=$reasonForHold, supportEmail=$supportEmail, url=$url, additionalProperties=$additionalProperties}"
}
