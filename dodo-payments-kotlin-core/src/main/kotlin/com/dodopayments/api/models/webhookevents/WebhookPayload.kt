...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [data] with `Data.ofPayout(payout)`. */
        fun data(payout: Data.Payout) = data(Data.ofPayout(payout))
    ...
    private constructor(
        ...
        private val payout: Payout? = null,
        ...
        fun isPayout(): Boolean = payout != null
        ...
        fun asPayout(): Payout = payout.getOrThrow("payout")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                payout != null -> visitor.visitPayout(payout)
        ...
        fun validate(): Data = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitPayout(payout: Payout) {
                        payout.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitPayout(payout: Payout) = payout.validity()
        ...
        override fun toString(): String =
            when {
                ...
                payout != null -> "Data{payout=$payout}"
        ...
        companion object {
            ...
            fun ofPayout(payout: Payout) = Data(payout = payout)
        ...
        interface Visitor<out T> {
            ...
            fun visitPayout(payout: Payout): T
        ...
        internal class Deserializer : BaseDeserializer<Data>(Data::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Data {
                ...
                when (payloadType) {
                    ...
                    "Payout" -> {
                        return tryDeserialize(node, jacksonTypeRef<Payout>())?.let {
                            Data(payout = it, _json = json)
                        } ?: Data(_json = json)
                    }
                    "CreditLedgerEntry" -> {
        ...
        internal class Serializer : BaseSerializer<Data>(Data::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.payout != null -> generator.writeObject(value.payout)
        ...
        private constructor(
            ...
            /**
             * An error message if the payment failed. When `error_code` is a recognised unified
             * code, this is the merchant-facing headline + recommended action (Payment Details
             * copy) rather than the raw connector text.
             *
             * @throws DodoPaymentsInvalidDataException if the JSON field has an unexpected type
             *   (e.g. if the server responded with an unexpected value).
             */
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                payoutId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("refunds")
                @ExcludeMissing
                refunds: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("status")
                @ExcludeMissing
             ...
             *
             * Unlike [chargebacks], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @Deprecated(
                "Use the v3 payout breakup endpoints instead. Will be removed in a future release."
             ...
             *
             * Unlike [payoutId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [payoutDocumentUrl], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("payout_document_url")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                private var payloadType: JsonValue = JsonValue.from("Payout")
                ...
                internal fun from(payout: Payout) = apply {
                    ...
                    chargebacks = payout.chargebacks
                    createdAt = payout.createdAt
                    currency = payout.currency
                    fee = payout.fee
                    payloadType = payout.payloadType
                    ...
                    name = payout.name
                    payoutDocumentUrl = payout.payoutDocumentUrl
                 ...
                 *
                 * You should usually call [Builder.chargebacks] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                @Deprecated(
                ...
                fun chargebacks(chargebacks: JsonField<Long>) = apply {
                 ...
                 *
                 * You should usually call [Builder.fee] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.payoutId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * Sets [Builder.refunds] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.refunds] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                @Deprecated(
                 ...
                 * Sets [Builder.tax] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.tax] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                @Deprecated(
                 ...
                 *
                 * You should usually call [Builder.payoutDocumentUrl] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            internal fun validity(): Int =
                (if (amount.asKnown() == null) 0 else 1) +
                    ...
                    payloadType.let { if (it == JsonValue.from("Payout")) 1 else 0 } +
                    (if (paymentMethod.asKnown() == null) 0 else 1) +
            ...
            override fun toString() =
                "Payout{amount=$amount, businessId=$businessId, chargebacks=$chargebacks, createdAt=$createdAt, currency=$currency, fee=$fee, payloadType=$payloadType, paymentMethod=$paymentMethod, payoutId=$payoutId, refunds=$refunds, status=$status, tax=$tax, updatedAt=$updatedAt, name=$name, payoutDocumentUrl=$payoutDocumentUrl, remarks=$remarks, additionalProperties=$additionalProperties}"
        }
