...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RefundListPageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(refundListPageResponse: RefundListPageResponse) = apply {
            items = refundListPageResponse.items.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [RefundListPageResponse].
         *
         ...
         */
        fun build(): RefundListPageResponse =
    ...
    fun validate(): RefundListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RefundListPageResponse && items == other.items && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "RefundListPageResponse{items=$items, additionalProperties=$additionalProperties}"
}
