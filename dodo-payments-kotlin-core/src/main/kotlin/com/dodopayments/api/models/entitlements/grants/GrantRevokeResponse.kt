...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = grantRevokeResponse.metadata().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GrantRevokeResponse].
         *
    ...
    /** A builder for [GrantRevokeResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(grantRevokeResponse: GrantRevokeResponse) = apply {
            id = grantRevokeResponse.id
            businessId = grantRevokeResponse.businessId
            createdAt = grantRevokeResponse.createdAt
            customerId = grantRevokeResponse.customerId
            entitlementId = grantRevokeResponse.entitlementId
            externalId = grantRevokeResponse.externalId
            status = grantRevokeResponse.status
            updatedAt = grantRevokeResponse.updatedAt
            deliveredAt = grantRevokeResponse.deliveredAt
            digitalProductDelivery = grantRevokeResponse.digitalProductDelivery
            errorCode = grantRevokeResponse.errorCode
            errorMessage = grantRevokeResponse.errorMessage
            licenseKey = grantRevokeResponse.licenseKey
            metadata = grantRevokeResponse.metadata
            oauthExpiresAt = grantRevokeResponse.oauthExpiresAt
            oauthUrl = grantRevokeResponse.oauthUrl
            paymentId = grantRevokeResponse.paymentId
            revocationReason = grantRevokeResponse.revocationReason
            revokedAt = grantRevokeResponse.revokedAt
            subscriptionId = grantRevokeResponse.subscriptionId
            additionalProperties = grantRevokeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GrantRevokeResponse].
         *
    ...
    fun validate(): GrantRevokeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GrantRevokeResponse &&
            id == other.id &&
