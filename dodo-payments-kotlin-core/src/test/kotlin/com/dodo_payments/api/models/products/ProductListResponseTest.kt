    ...
    fun createProductListResponse() {
        val productListResponse =
            ProductListResponse.builder()
                ...
                .price(0L)
                .priceDetail(
                    ProductListResponse.PriceDetail.OneTimePrice.builder()
                        .currency(ProductListResponse.PriceDetail.OneTimePrice.Currency.AED)
                        .discount(0.0)
                        .price(0L)
                        .purchasingPowerParity(true)
                        .type(ProductListResponse.PriceDetail.OneTimePrice.Type.ONE_TIME_PRICE)
                        .payWhatYouWant(true)
                        .suggestedPrice(0L)
                        .taxInclusive(true)
                        .build()
        ...
        assertThat(productListResponse.priceDetail())
            .isEqualTo(
                ProductListResponse.PriceDetail.ofOneTimePrice(
                    ProductListResponse.PriceDetail.OneTimePrice.builder()
                        .currency(ProductListResponse.PriceDetail.OneTimePrice.Currency.AED)
                        .discount(0.0)
                        .price(0L)
