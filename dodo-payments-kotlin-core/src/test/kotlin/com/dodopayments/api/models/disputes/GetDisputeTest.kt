    ...
    fun create() {
        val getDispute =
            GetDispute.builder()
                ...
                .paymentProvider(GetDispute.PaymentProvider.STRIPE)
        ...
        assertThat(getDispute.brandId()).isEqualTo("brand_id")
        ...
        assertThat(getDispute.paymentProvider()).isEqualTo(GetDispute.PaymentProvider.STRIPE)
