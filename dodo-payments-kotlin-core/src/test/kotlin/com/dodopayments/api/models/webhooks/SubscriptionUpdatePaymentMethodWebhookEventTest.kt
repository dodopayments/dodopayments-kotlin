...
internal class SubscriptionUpdatePaymentMethodWebhookEventTest {

    @Test
    fun create() {
        val subscriptionUpdatePaymentMethodWebhookEvent =
        ...
        assertThat(subscriptionUpdatePaymentMethodWebhookEvent.businessId())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionUpdatePaymentMethodWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionUpdatePaymentMethodWebhookEvent),
                jacksonTypeRef<SubscriptionUpdatePaymentMethodWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionUpdatePaymentMethodWebhookEvent)
            .isEqualTo(subscriptionUpdatePaymentMethodWebhookEvent)
    }
}
