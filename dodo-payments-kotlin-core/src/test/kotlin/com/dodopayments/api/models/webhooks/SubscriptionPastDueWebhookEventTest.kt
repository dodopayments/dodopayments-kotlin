...
internal class SubscriptionPastDueWebhookEventTest {

    @Test
    fun create() {
        val subscriptionPastDueWebhookEvent =
        ...
        assertThat(subscriptionPastDueWebhookEvent.businessId()).isEqualTo("business_id")
        assertThat(subscriptionPastDueWebhookEvent.data())
            .isEqualTo(
                SubscriptionPastDueWebhookEvent.Data.builder()
                    .addAddon(
                        AddonCartResponseItem.builder().addonId("addon_id").quantity(0).build()
        ...
        assertThat(subscriptionPastDueWebhookEvent.timestamp())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionPastDueWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionPastDueWebhookEvent),
                jacksonTypeRef<SubscriptionPastDueWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionPastDueWebhookEvent)
            .isEqualTo(subscriptionPastDueWebhookEvent)
    }
}
