...
internal class PaymentFailedWebhookEventTest {

    @Test
    fun create() {
        val paymentFailedWebhookEvent =
        ...
        assertThat(paymentFailedWebhookEvent.type())
            .isEqualTo(PaymentFailedWebhookEvent.Type.PAYMENT_FAILED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedPaymentFailedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(paymentFailedWebhookEvent),
                jacksonTypeRef<PaymentFailedWebhookEvent>(),
            )

        assertThat(roundtrippedPaymentFailedWebhookEvent).isEqualTo(paymentFailedWebhookEvent)
    }
}
