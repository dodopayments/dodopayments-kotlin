...
internal class PaymentProcessingWebhookEventTest {

    @Test
    fun create() {
        val paymentProcessingWebhookEvent =
    ...
    fun roundtrip() {
        ...
        val roundtrippedPaymentProcessingWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(paymentProcessingWebhookEvent),
                jacksonTypeRef<PaymentProcessingWebhookEvent>(),
            )

        assertThat(roundtrippedPaymentProcessingWebhookEvent)
            .isEqualTo(paymentProcessingWebhookEvent)
    }
}
