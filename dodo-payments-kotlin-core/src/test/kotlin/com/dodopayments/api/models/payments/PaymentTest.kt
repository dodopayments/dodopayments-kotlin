...
internal class PaymentTest {
    ...
    fun create() {
        ...
        assertThat(payment.failureDetails())
            .isEqualTo(
                Payment.FailureDetails.builder()
                    .code("code")
                    .customerCta(Payment.FailureDetails.CustomerCta.EDIT_AND_RETRY)
        ...
        assertThat(payment.invoiceId()).isEqualTo("invoice_id")
        ...
        assertThat(payment.refundStatus()).isEqualTo(PaymentRefundStatus.PARTIAL)
