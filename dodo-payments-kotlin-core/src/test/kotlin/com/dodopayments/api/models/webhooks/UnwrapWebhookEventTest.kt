...
internal class UnwrapWebhookEventTest {
    ...
    fun ofAbandonedCheckoutDetected() {
        ...
        assertThat(unwrapWebhookEvent.payoutCreated()).isNull()
        assertThat(unwrapWebhookEvent.payoutFailed()).isNull()
        assertThat(unwrapWebhookEvent.payoutInProgress()).isNull()
        assertThat(unwrapWebhookEvent.payoutOnHold()).isNull()
        assertThat(unwrapWebhookEvent.payoutSuccess()).isNull()
        ...
        assertThat(unwrapWebhookEvent.subscriptionPastDue()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionPaused()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionPlanChanged()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionRenewed()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionUnpaused()).isNull()
    ...
    fun ofPayoutCreated() {
        ...
        assertThat(unwrapWebhookEvent.paymentProcessing()).isNull()
        assertThat(unwrapWebhookEvent.paymentSucceeded()).isNull()
        assertThat(unwrapWebhookEvent.payoutCreated()).isEqualTo(payoutCreated)
        assertThat(unwrapWebhookEvent.payoutFailed()).isNull()
        assertThat(unwrapWebhookEvent.payoutInProgress()).isNull()
        assertThat(unwrapWebhookEvent.payoutOnHold()).isNull()
        assertThat(unwrapWebhookEvent.payoutSuccess()).isNull()
    ...
    fun ofPayoutFailed() {
        ...
        assertThat(unwrapWebhookEvent.paymentSucceeded()).isNull()
        assertThat(unwrapWebhookEvent.payoutCreated()).isNull()
        assertThat(unwrapWebhookEvent.payoutFailed()).isEqualTo(payoutFailed)
        assertThat(unwrapWebhookEvent.payoutInProgress()).isNull()
        assertThat(unwrapWebhookEvent.payoutOnHold()).isNull()
        assertThat(unwrapWebhookEvent.payoutSuccess()).isNull()
        assertThat(unwrapWebhookEvent.refundFailed()).isNull()
    ...
    fun ofPayoutInProgress() {
        ...
        assertThat(unwrapWebhookEvent.payoutCreated()).isNull()
        assertThat(unwrapWebhookEvent.payoutFailed()).isNull()
        assertThat(unwrapWebhookEvent.payoutInProgress()).isEqualTo(payoutInProgress)
        assertThat(unwrapWebhookEvent.payoutOnHold()).isNull()
        assertThat(unwrapWebhookEvent.payoutSuccess()).isNull()
        assertThat(unwrapWebhookEvent.refundFailed()).isNull()
        assertThat(unwrapWebhookEvent.refundSucceeded()).isNull()
    ...
    fun ofPayoutOnHold() {
        ...
        assertThat(unwrapWebhookEvent.payoutFailed()).isNull()
        assertThat(unwrapWebhookEvent.payoutInProgress()).isNull()
        assertThat(unwrapWebhookEvent.payoutOnHold()).isEqualTo(payoutOnHold)
        assertThat(unwrapWebhookEvent.payoutSuccess()).isNull()
        assertThat(unwrapWebhookEvent.refundFailed()).isNull()
        assertThat(unwrapWebhookEvent.refundSucceeded()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionActive()).isNull()
    ...
    fun ofPayoutSuccess() {
        ...
        assertThat(unwrapWebhookEvent.payoutInProgress()).isNull()
        assertThat(unwrapWebhookEvent.payoutOnHold()).isNull()
        assertThat(unwrapWebhookEvent.payoutSuccess()).isEqualTo(payoutSuccess)
        assertThat(unwrapWebhookEvent.refundFailed()).isNull()
        assertThat(unwrapWebhookEvent.refundSucceeded()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionActive()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionCancelled()).isNull()
    ...
    @Test
    fun ofSubscriptionPastDue() {
        val subscriptionPastDue =
            SubscriptionPastDueWebhookEvent.builder()
                .businessId("business_id")
                .data(
                    SubscriptionPastDueWebhookEvent.Data.builder()
                        .addAddon(
                            AddonCartResponseItem.builder().addonId("addon_id").quantity(0).build()
                        )
                        .billing(
        ...
        val unwrapWebhookEvent = UnwrapWebhookEvent.ofSubscriptionPastDue(subscriptionPastDue)
        ...
        assertThat(unwrapWebhookEvent.subscriptionFailed()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionOnHold()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionPastDue()).isEqualTo(subscriptionPastDue)
        assertThat(unwrapWebhookEvent.subscriptionPaused()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionPlanChanged()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionRenewed()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionUnpaused()).isNull()
    ...
    @Test
    fun ofSubscriptionPastDueRoundtrip() {
        val jsonMapper = jsonMapper()
        val unwrapWebhookEvent =
            UnwrapWebhookEvent.ofSubscriptionPastDue(
                SubscriptionPastDueWebhookEvent.builder()
                    .businessId("business_id")
                    .data(
                        SubscriptionPastDueWebhookEvent.Data.builder()
    ...
    fun ofSubscriptionPaused() {
        val subscriptionPaused =
            SubscriptionPausedWebhookEvent.builder()
                .businessId("business_id")
                .data(
                    SubscriptionPausedWebhookEvent.Data.builder()
                        .addAddon(
                            AddonCartResponseItem.builder().addonId("addon_id").quantity(0).build()
                        )
                        .billing(
        ...
        assertThat(unwrapWebhookEvent.subscriptionOnHold()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionPastDue()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionPaused()).isEqualTo(subscriptionPaused)
        assertThat(unwrapWebhookEvent.subscriptionPlanChanged()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionRenewed()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionUnpaused()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionUpdatePaymentMethod()).isNull()
    ...
    fun ofSubscriptionUnpaused() {
        ...
        assertThat(unwrapWebhookEvent.subscriptionPlanChanged()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionRenewed()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionUnpaused()).isEqualTo(subscriptionUnpaused)
        assertThat(unwrapWebhookEvent.subscriptionUpdatePaymentMethod()).isNull()
        assertThat(unwrapWebhookEvent.subscriptionUpdated()).isNull()
    }
