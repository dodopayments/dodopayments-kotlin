...
internal class SubscriptionUnpausedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionUnpausedWebhookEvent =
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionUnpausedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionUnpausedWebhookEvent),
                jacksonTypeRef<SubscriptionUnpausedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionUnpausedWebhookEvent)
            .isEqualTo(subscriptionUnpausedWebhookEvent)
    }
}
