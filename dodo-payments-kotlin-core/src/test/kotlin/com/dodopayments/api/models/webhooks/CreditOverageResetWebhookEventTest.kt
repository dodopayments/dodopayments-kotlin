...
internal class CreditOverageResetWebhookEventTest {
    ...
    @Test
    fun create() {
        val creditOverageResetWebhookEvent =
        ...
        assertThat(creditOverageResetWebhookEvent.data())
            .isEqualTo(
                CreditLedgerEntry.builder()
                    .id("id")
                    .amount("amount")
    ...
    fun roundtrip() {
        ...
        val roundtrippedCreditOverageResetWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(creditOverageResetWebhookEvent),
                jacksonTypeRef<CreditOverageResetWebhookEvent>(),
            )

        assertThat(roundtrippedCreditOverageResetWebhookEvent)
            .isEqualTo(creditOverageResetWebhookEvent)
    }
}
