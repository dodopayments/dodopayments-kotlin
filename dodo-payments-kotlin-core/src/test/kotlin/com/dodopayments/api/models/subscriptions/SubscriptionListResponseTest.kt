...
internal class SubscriptionListResponseTest {
    ...
    fun create() {
        ...
        assertThat(subscriptionListResponse.paymentFrequencyCount()).isEqualTo(0L)
        ...
        assertThat(subscriptionListResponse.quantity()).isEqualTo(0L)
        assertThat(subscriptionListResponse.recurringPreTaxAmount()).isEqualTo(0L)
        ...
        assertThat(subscriptionListResponse.subscriptionPeriodCount()).isEqualTo(0L)
        ...
        assertThat(subscriptionListResponse.trialPeriodDays()).isEqualTo(0L)
