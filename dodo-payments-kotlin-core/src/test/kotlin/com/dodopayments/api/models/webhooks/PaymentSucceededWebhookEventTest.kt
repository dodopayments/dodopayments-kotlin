...
internal class PaymentSucceededWebhookEventTest {

    @Test
    fun create() {
        val paymentSucceededWebhookEvent =
        ...
        assertThat(paymentSucceededWebhookEvent.businessId()).isEqualTo("business_id")
        assertThat(paymentSucceededWebhookEvent.data())
            .isEqualTo(
                PaymentSucceededWebhookEvent.Data.builder()
                    .billing(
                        BillingAddress.builder()
        ...
        assertThat(paymentSucceededWebhookEvent.timestamp())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(paymentSucceededWebhookEvent.type())
            .isEqualTo(PaymentSucceededWebhookEvent.Type.PAYMENT_SUCCEEDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedPaymentSucceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(paymentSucceededWebhookEvent),
                jacksonTypeRef<PaymentSucceededWebhookEvent>(),
            )

        assertThat(roundtrippedPaymentSucceededWebhookEvent).isEqualTo(paymentSucceededWebhookEvent)
    }
}
