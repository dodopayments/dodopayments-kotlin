...
internal class PaymentCancelledWebhookEventTest {

    @Test
    fun create() {
        val paymentCancelledWebhookEvent =
        ...
        assertThat(paymentCancelledWebhookEvent.data())
            .isEqualTo(
                PaymentCancelledWebhookEvent.Data.builder()
                    .billing(
                        BillingAddress.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedPaymentCancelledWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(paymentCancelledWebhookEvent),
                jacksonTypeRef<PaymentCancelledWebhookEvent>(),
            )

        assertThat(roundtrippedPaymentCancelledWebhookEvent).isEqualTo(paymentCancelledWebhookEvent)
    }
}
